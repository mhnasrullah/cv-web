    ...
    <nav className='py-6'>
        <Box className={"flex justify-between items-center"}>
            ...
            <div className={`fixed flex flex-col inset-x-0 transition-all ${!show ? "-top-full" : "top-0"} pt-24 lg:pt-0 lg:pb-0 lg:border-0 border-b-2 border-b-green pb-10 lg:static lg:block`}>
                <button className='text-lg lg:text-base lg:ml-16 my-3 hover:scale-110 transition-all'>About</button>
                <button className='text-lg lg:text-base lg:ml-16 my-3 hover:scale-110 transition-all'>Projects</button>
                <button className='text-lg lg:text-base lg:ml-16 my-3 hover:scale-110 transition-all'>Contact</button>
            </div>
        </Box>
    </nav>
  )
